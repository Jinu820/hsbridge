  ...
  return (
    ...
    >
      <div className="mx-auto max-w-xl">
        ...
        <div className="mb-10 space-y-2 text-center text-sm text-zinc-400">
        ...
        >
          ...
          <div>
            ...
            <select
              className="w-full rounded border border-white/20 bg-white/5 px-4 py-3 text-white focus:border-yellow-500 focus:outline-none"
              defaultValue=""
            >
          ...
          <button
            ...
            disabled={sending}
            className="w-full rounded-full bg-yellow-500 py-4 text-sm font-semibold uppercase tracking-widest text-black transition hover:bg-yellow-400 disabled:opacity-50 disabled:cursor-not-allowed"
          >
            {sending ? "送信中..." : "Submit"}
          </button>
        </form>
      ...
      {modal && (
        ...
        >
          <div
            className="w-full max-w-sm rounded-xl border border-white/20 bg-zinc-900 p-6 shadow-xl"
          ...
          >
            ...
            <button
              type="button"
              onClick={() => setModal(null)}
              className="w-full rounded-full bg-yellow-500 py-3 text-sm font-semibold text-black transition hover:bg-yellow-400"
            >
              閉じる
            </button>
          </div>
